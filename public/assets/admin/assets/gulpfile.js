...
gulp.task('sass', () => {
    var compile =  gulp.src('assets/admin/assets/scss/**/style.scss')
        .pipe(sourcemaps.init())
        .pipe(sass().on('error', sass.logError))
        .pipe(sourcemaps.write('./maps'))
        .pipe(gulp.dest('./assets/admin/assets/css'))
        .pipe(browserSync.stream());
    var minify =  gulp.src('assets/admin/assets/css/**/style.css')
...
gulp.task('serve', gulp.series( 'sass', () => {
    ...
    gulp.watch('assets/admin/assets/scss/**/*.scss', gulp.series('sass'));
    gulp.watch('**/*.html').on('change', browserSync.reload);
    gulp.watch('assets/admin/assets/js/**/*.js').on('change', browserSync.reload);
...
gulp.task('replacePaths', () => {
    var path1 = gulp.src('./*/pages/*/*.html', {base: './'})
        .pipe(replace('="assets/admin/assets/', '="../../../assets/admin/assets/'))
...
gulp.task('injectCommonAssets', () => {
    ...
    .pipe(inject(gulp.src([
        './assets/admin/assets/vendors/core/core.css',
        './assets/admin/assets/vendors/core/core.js'
    ], {read: false}), {name:'core', relative: true}))
    .pipe(inject(gulp.src([
        './assets/admin/assets/vendors/feather-icons/feather.min.js',
        './assets/admin/assets/js/template.js',
        './assets/admin/assets/fonts/feather-font/css/iconfont.css',
        './assets/admin/assets/vendors/flag-icon-css/css/flag-icon.min.css'
...
gulp.task('buildCoreCss', () => {
    return gulp.src([
        ...
        .pipe(gulp.dest('./assets/admin/assets/vendors/core'));
});
