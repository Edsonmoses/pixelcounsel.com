...
class AddEvent2Component extends Component
{
    use WithFileUploads;
    public $name;
    public $slug;
    ...
    public function render()
    {
        if (is_null(Auth::user()->confirm_status_at)) {
            ...
            return view('livewire.add-event2-component', ['eventcategories' => $eventcategories, 'eventtypes' => $eventtypes])->layout('layouts.baseapp');
        }
    }
}
