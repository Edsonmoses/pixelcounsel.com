...
<header class="intro-header intro-jargon">
    <div class="container">
        <div class="row">
          ...
          <input class="form-control" placeholder="A comprehensive dictionary of web, architecture, design and printing terms" name="query" id="ed-srch-term" type="text"  wire:model="searchTerm">
