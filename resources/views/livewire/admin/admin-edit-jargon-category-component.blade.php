                    ...
                    @foreach ($jargons as $jargon)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" onclick="confirm('Ara you sure, You want to delete this jargon category') || event.stopImmediatePropagation()" wire:click.prevent="deleteJargon({{ $jargon->id }})" style="margin-left: 10px"><i class="fa fa-times fa-1x text-danger"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
