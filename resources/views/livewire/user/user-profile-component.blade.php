                        ...
                        <div class="d-flex align-items-top">
                          ...
                          @endif
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                ...
                                <p class="font-13">{{ $user->profile->about }}</p>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group mb-0 user-list">
                            <li class="list-group-item">
                                <a href="#" class="user-list-item">
                                    <div class="user avatar-sm float-start me-2">
                                        <img src="{{ asset('assets/user/assets/images/users/user-2.jpg')}}" alt="" class="img-fluid rounded-circle">
                                    </div>
                                    <div class="user-desc">
                            ...
                            <li class="list-group-item">
                                <a href="#" class="user-list-item">
                                    <div class="user avatar-sm float-start me-2">
                                        <img src="{{ asset('assets/user/assets/images/users/user-3.jpg')}}" alt="" class="img-fluid rounded-circle">
                                    </div>
                                    <div class="user-desc">
                            ...
                            <li class="list-group-item">
                                <a href="#" class="user-list-item">
                                    <div class="user avatar-sm float-start me-2">
                                        <img src="{{ asset('assets/user/assets/images/users/user-5.jpg')}}" alt="" class="img-fluid rounded-circle">
                                    </div>
                                    <div class="user-desc">
                            ...
                            <li class="list-group-item">
                                <a href="#" class="user-list-item">
                                    <div class="user avatar-sm float-start me-2">
                                        <img src="{{ asset('assets/user/assets/images/users/user-6.jpg')}}" alt="" class="img-fluid rounded-circle">
                                    </div>
                                    <div class="user-desc">
                                        <h5 class="name mt-0 mb-1">Michael Zenaty</h5>
                            ...
                            <li class="list-group-item">
                                <a href="#" class="user-list-item">
                                    <div class="user avatar-sm float-start me-2">
                                        <img src="{{ asset('assets/user/assets/images/users/user-1.jpg')}}" alt="" class="img-fluid rounded-circle">
                                    </div>
                                    <div class="user-desc">
