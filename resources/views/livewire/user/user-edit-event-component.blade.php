                          ...
                          <div class="d-flex align-items-top">
                            ...
                            @endif
                              <div class="flex-grow-1 overflow-hidden">
                                <form class="form-horizontal" id="updated-form" wire:submit.prevent="updateEvent">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                  ...
                                  <div class="col-lg-12">
                                    ...
                                    <button type="submit" class="btn btn-success pull-right">Update a event</button>
                                </form>
                              </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
            ...
            Your event has been updated successfully!</p>
            <a href="{{route('user.evadd')}}" class="btn btn-success">Add another event</a>
        </div>
      </div>
    </div>
  </div>
